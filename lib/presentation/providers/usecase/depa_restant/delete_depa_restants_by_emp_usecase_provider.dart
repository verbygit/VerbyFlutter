...
final deleteDepaRestantByEmpProvider = Provider<DeleteDepaRestantsByEmpUseCase>((ref) {
  return DeleteDepaRestantsByEmpUseCase(ref.watch(depaRestantLocalRepoProvider));
});
