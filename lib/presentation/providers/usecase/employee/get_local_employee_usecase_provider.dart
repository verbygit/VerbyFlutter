...
import 'package:verby_flutter/presentation/providers/reposiory/employee_local_repo_provider.dart';
...
final getLocalEmployeeUseCaseProvider = Provider<GetLocalEmployeeUseCase>((ref) {
  final employeeRepository = ref.watch(employeeLocalRepoProvider);
  return GetLocalEmployeeUseCase(employeeRepository);
});
