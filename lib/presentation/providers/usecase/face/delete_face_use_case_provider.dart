...
import 'package:verby_flutter/domain/use_cases/face/delete_face_use_case.dart';
...
final deleteFaceUseCaseProvider = Provider<DeleteFaceUseCase>((ref) {
  final faceRepositoryProvider = ref.read(faceRepoProvider);
  return DeleteFaceUseCase(faceRepositoryProvider);
});
